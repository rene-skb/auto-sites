...
- **Live URL:** https://auto-sites.pages.dev/demos/miller-fence-and-deck/ (pushed in commit `d715be2`; raw GitHub serves the Miller HTML, but the Pages route was still serving the Auto-Sites portfolio fallback at verification time)
...
- **Live URL:** https://auto-sites.pages.dev/demos/hutchinson-contracting/ (pushed in commits `80e246d` and `e1ac74f`; raw GitHub serves the Hutchinson HTML, but the Pages route was still serving the Auto-Sites portfolio fallback at verification time)
...
- **Live URL:** https://auto-sites.pages.dev/demos/pross-renovations-ltd/ (pushed to GitHub in commit `dfe20ca`; raw GitHub serves the Pross HTML, but the Pages route was still serving the Auto-Sites portfolio fallback at verification time)
...
- **Live URL:** https://auto-sites.pages.dev/demos/larix-landscape/ (pushed to GitHub in commit `eeefc17`; raw GitHub serves the Larix HTML, but the Pages route was still serving the Auto-Sites portfolio fallback at verification time, so live verification is pending propagation)
...
- **Live URL:** https://auto-sites.pages.dev/demos/island-pro-mowing-and-landscaping/ (route serves the Island Pro demo; final QA/demo commit 2b8c02f and follow-up deployment-status commits pushed, but the Pages route was still serving the pre-QA version at latest verification)
...
- **Model:** openai-codex/gpt-5.5
- **Agent:** Lucy
- **Folder:** shafran-construction-inc
- **Hero pattern:** image-top-text-below / type-led square project card
- **Typography:** Libre Baskerville + Epilogue
- **Review layout:** no customer review cards; proof section uses checkable contractor facts, CSLB license #547455, service-area/contact details, and official project imagery because compliant named reviews were not verified
- **Visit/hours layout:** final dark estimate/contact card with phone, email, office address, license number, and quote-prep guidance; no map link because a canonical named Google Maps business listing URL was not confidently verified
- **Stats bar style:** no-stats
- **WHY Score:** 7.97 (Jobs 8.1 / Graham 7.8 / Ogilvy 8.0)
- **WHAT Score:** 8.03 (Norman 8.2 / Krug 8.0 / Nielsen 7.9)
...
- **Token estimate:** ~38k
- **Key decisions:** Built Shafran as a calm estimate-prep page around four source-backed service modes: build, renovate, repair, and upgrade. Used official project images only, kept license claims attached to CSLB Lic# 547455, and replaced the blurry license bitmap with accessible live text in the designed proof panel.
...
- **Live URL:** https://auto-sites.pages.dev/demos/hillside-expert-electrical/ (pushed to GitHub in build commit be6b9e2 plus deployment-status update 8a79c8d; Pages route still serving the portfolio landing page at verification time)
...
- **Live URL:** https://auto-sites.pages.dev/demos/arbor-renovations/ (pushed in commit 5cacc4e; raw GitHub serves the Arbor HTML; Pages route still serving the portfolio landing page at verification time)
